...
app.directive('accountSelector', ['ethereum','$rootScope', function(ethereum, $rootScope) {
	'use strict';
	return {
		restrict: 'E',
...
app.service('proposalService', ['$q','ethereum','$rootScope', function($q, ethereum, $rootScope) {
